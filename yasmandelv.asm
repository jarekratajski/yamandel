; mandelbrot calculation in assembly using horizontal vectorization
...
; in real life it makes more sense to use gcc/intel intrinsics
...
mandelbrotAsmV:
    ...
    ;it appeared there is no need to save params on stack
